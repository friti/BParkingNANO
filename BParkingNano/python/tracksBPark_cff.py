...
tracksBPark = cms.EDProducer('TrackMerger',
                             ...
                             dzTrg_cleaning = cms.double(1.), # set to negative to disable. Only when BOTH dzTrg_cleaning and drTrg_Cleaning are negative, the BParking trigger is _really_ disabled, otherwise it implicitly requires the trgMuon collection to be non-empty
                             drTrg_Cleaning = cms.double(0.03), # set to negative to disable. Only when BOTH dzTrg_cleaning and drTrg_Cleaning are negative, the BParking trigger is _really_ disabled, otherwise it implicitly requires the trgMuon collection to be non-empty
