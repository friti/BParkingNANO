...
muonPairsForpmm = cms.EDProducer(
    'DiMuonBuilder',
...
BTopmm = cms.EDProducer(
    'BTopmmBuilder',
    dileptons = cms.InputTag('muonPairsForpmm'),
    leptonTransientTracks = muonPairsForpmm.transientTracksSrc,
    kaons = BToKee.kaons,
...
BTopmmTable = cms.EDProducer(
    'SimpleCompositeCandidateFlatTableProducer',
    src = cms.InputTag("BTopmm"),
    cut = cms.string(""),
    name = cms.string("BTopmm"),
    doc = cms.string("BTopmm Variable"),
    singleton=cms.bool(False),
    extension=cms.bool(False),
    variables=cms.PSet(
        # pre-fit quantities                                                      
...
BToKLLTables = cms.Sequence(BToKeeTable + BTopmmTable)
