...
muonPairsForkmm = cms.EDProducer(
    'DiMuonBuilder',
...
BTokmm = cms.EDProducer(
    'BTokmmBuilder',
    dileptons = cms.InputTag('muonPairsForkmm'),
    leptonTransientTracks = muonPairsForkmm.transientTracksSrc,
    kaons = BToKee.kaons,
...
BTokmmTable = cms.EDProducer(
    'SimpleCompositeCandidateFlatTableProducer',
    src = cms.InputTag("BTokmm"),
    cut = cms.string(""),
    name = cms.string("BTokmm"),
    doc = cms.string("BTokmm Variable"),
    singleton=cms.bool(False),
    extension=cms.bool(False),
    variables=cms.PSet(
        # pre-fit quantities                                                      
...
BToKLLTables = cms.Sequence(BToKeeTable + BTokmmTable)
